  ...
  return (
    <div>
      <h1 className="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl dark:text-blue">
        {isSpanish ? '¿Te gustaría un Portfolio como este?' : 'Would you like a Portfolio like this?'}
        ...
        <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary dark:from-primaryLight dark:to-secondaryLight">
          {isSpanish ? '¿Tener tu propia Landing Page? ¡Contáctame y hablemos!' : 'Have your own Landing Page? Contact me and let\'s talk!'}
        </span>
      </h1>
      <button className="btn btn-primary" onClick={toggleLanguage}>
        {isSpanish ? 'Work with me!' : '¡Trabaja conmigo!'}
      </button>
